...
public class NotificationBinder extends RecyclerViewBinder<NotificationEnt> {
    ...
    public NotificationBinder(Context context, BasePreferenceHelper prefHelper, RecyclerClickListner listner,PopupClickListner popupClickListner) {
    ...
    @Override
    public void bindView(NotificationEnt entity, int position, Object holder, Context context) {
